...
function LocationSection() {
  ...
  return (
    <section className="bg-gray-100 py-16 px-6">
      ...
      <p className="text-center font-semibold text-[20px] mb-7">
        We Are More Than Our Manufacturing
      </p>

      {/* Mobile = flex column | Desktop = grid */}
      <div className="flex flex-col gap-4 lg:grid lg:grid-cols-3 lg:gap-6 max-w-7xl mx-auto">
        {locations.map((item, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <h2 className="text-white text-lg md:text-2xl font-semibold tracking-wide text-center px-2">
                {item.name}
              </h2>
            </div>
          </div>
